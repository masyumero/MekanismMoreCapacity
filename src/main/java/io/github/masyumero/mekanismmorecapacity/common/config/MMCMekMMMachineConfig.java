...
public class MMCMekMMMachineConfig extends BaseMekanismConfig {
    ...
    public final CachedLongValue OverclockedDissolvingFactoryOutput;
    public final CachedLongValue QuantumDissolvingFactoryOutput;
    public final CachedLongValue DenseDissolvingFactoryOutput;
    public final CachedLongValue MultiversalDissolvingFactoryOutput;
...
//    public final CachedLongValue UltimateSolarNeutronActivatingFactoryoutput;
    ...
    public MMCMekMMMachineConfig() {
        ...
        OverclockedDissolvingFactoryOutput =      CachedLongValue.wrap(this, builder.comment("Chemical tank capacity (mB). Default: 11000000, Vanilla: 110000").defineInRange("OverclockedChemicalOutputTankCapacity", 11000000, 1, Long.MAX_VALUE));
        ...
        MultiversalDissolvingFactoryOutput =      CachedLongValue.wrap(this, builder.comment("Chemical tank capacity (mB). Default: 17000000, Vanilla: 170000").defineInRange("MultiversalChemicalOutputTankCapacity", 17000000, 1, Long.MAX_VALUE));
