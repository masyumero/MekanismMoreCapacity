...
public class MMCMekMachineConfig extends BaseMekanismConfig {
    ...
    public final CachedLongValue PressurizedReactionChamberChemicalInput;
    public final CachedLongValue PressurizedReactionChamberChemicalOutput;
    ...
    public MMCMekMachineConfig() {
        ...
        PressurizedReactionChamberChemicalInput = CachedLongValue.wrap(this,builder.comment("Chemical tank capacity (mB). Default: 1000000, Vanilla: 10000").defineInRange("inputChemicalTankCapacity",1000000,1,Long.MAX_VALUE));
        PressurizedReactionChamberChemicalOutput = CachedLongValue.wrap(this,builder.comment("Chemical tank capacity (mB). Default: 1000000, Vanilla: 10000").defineInRange("outputChemicalTankCapacity",1000000,1,Long.MAX_VALUE));
